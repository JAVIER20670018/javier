public class zapato{
    ...
    // Constructor
    public zapato(String marca, String modelo, String color, int talla, String genero, boolean estaDisponible) {
        this.marca = marca;
        this.modelo = modelo;
        this.color = color;
        this.talla = talla;
    ...
    public static void main(String[] args) {
        ...
        zapato zapato1 = new zapato("Adidas", "adi", "negro", 7, "Hombre", true);
